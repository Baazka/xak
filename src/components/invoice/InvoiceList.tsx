...
const InvoiceListTable: React.FC = () => {
  ...
  const totalPages: number = Math.ceil(sortedInvoices.length / itemsPerPage) || 1;
  ...
  const sortBy = (field: "number" | "customer" | "creationDate" | "dueDate" | "total"): void => {
    setSort((prev) => ({
      sortBy: field,
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <span className="flex flex-col gap-0.5">
                    <svg
                      className={
                        sort.sortBy === "customer" && sort.sortDirection === "asc"
                          ? "text-gray-500"
                          : "text-gray-300"
                      }
                      width="8"
                    ...
                    <svg
                      className={
                        sort.sortBy === "customer" && sort.sortDirection === "desc"
                          ? "text-gray-500"
                          : "text-gray-300"
                      }
                      width="8"
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <span className="flex flex-col gap-0.5">
                    <svg
                      className={
                        sort.sortBy === "creationDate" && sort.sortDirection === "asc"
                          ? "text-gray-500"
                          : "text-gray-300"
                      }
                      width="8"
                    ...
                    <svg
                      className={
                        sort.sortBy === "creationDate" && sort.sortDirection === "desc"
                          ? "text-gray-500"
                          : "text-gray-300"
                      }
                      width="8"
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <span className="flex flex-col gap-0.5">
                    <svg
                      className={
                        sort.sortBy === "dueDate" && sort.sortDirection === "asc"
                          ? "text-gray-500"
                          : "text-gray-300"
                      }
                      width="8"
                    ...
                    <svg
                      className={
                        sort.sortBy === "dueDate" && sort.sortDirection === "desc"
                          ? "text-gray-500"
                          : "text-gray-300"
                      }
                      width="8"
      ...
      <div className="flex items-center flex-col sm:flex-row justify-between border-t border-gray-200 px-5 py-4 dark:border-gray-800">
        <div className="pb-4 sm:pb-0">
          <span className="block text-sm font-medium text-gray-500 dark:text-gray-400">
            ...
            <span className="text-gray-800 dark:text-white/90">{sortedInvoices.length}</span>
          </span>
        </div>
