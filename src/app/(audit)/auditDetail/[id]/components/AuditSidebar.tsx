  ...
  return (
    <div className="relative h-full w-24 shrink-0">
      <div className="group h-full">
        <div className="absolute left-0 top-0 flex h-full min-h-0 w-24 flex-col overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm transition-all duration-300 group-hover:w-84 dark:border-gray-800 dark:bg-gray-900">
