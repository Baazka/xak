...
const AppHeader: React.FC = () => {
  ...
  return (
    <header className="sticky top-0 flex w-full bg-white border-gray-200 z-555 dark:border-gray-800 dark:bg-gray-900 xl:border-b">
      <div className="flex flex-col items-center justify-between grow xl:flex-row xl:px-6">
        <div className="flex items-center justify-between w-full gap-2 px-3 py-3 border-b border-gray-200 dark:border-gray-800 sm:gap-4 xl:justify-normal xl:border-b-0 xl:px-0 xl:py-4">
          <button
            className={`flex items-center justify-center w-10 h-10 text-gray-500 border-gray-200 rounded-lg z-555 dark:border-gray-800 dark:text-gray-400 lg:h-11 lg:w-11 xl:border lg:bg-transparent dark:lg:bg-transparent ${
